...
# больший отрезок относится к всему отрезку также как меньшая часть к большей, когда мы выбираем интервал точка становится на свое место, одна из точек совпадет с уже имеющейся
